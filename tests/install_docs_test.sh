...
assert_contains "docs/tmux.md" "Start tmux"
assert_contains "docs/tmux.md" "Attach to a session"
assert_contains "docs/tmux.md" "Daily workflow"
assert_contains "docs/tmux.md" "Use cases"
assert_contains "docs/tmux.md" "copy mode"
assert_contains "docs/tmux.md" "Pairing Neovim with shell panes"
assert_contains "docs/debugging.md" "Debugger architecture"
assert_contains "docs/debugging.md" "ASCII layout"
assert_contains "docs/debugging.md" "Go debugging"
assert_contains "docs/debugging.md" "Python debugging"
assert_contains "docs/debugging.md" "PHP debugging"
assert_contains "docs/debugging.md" "debugpy"
assert_contains "docs/debugging.md" "Delve"
assert_contains "docs/debugging.md" "Xdebug"
assert_contains "docs/debugging.md" "DAP UI"
assert_contains "docs/plugins.md" "catppuccin/tmux"
assert_contains "docs/plugins.md" "mason-nvim-dap.nvim"
assert_contains "docs/keybindings.md" "<leader>dq"
assert_contains "docs/troubleshooting.md" "Lazy"
assert_contains "docs/troubleshooting.md" "TPM"
assert_contains "docs/troubleshooting.md" "debugpy"
...
assert_contains "lua/plugins/debugging.lua" "nvim-dap-python"
assert_contains "lua/plugins/debugging.lua" "mason-nvim-dap.nvim"
assert_contains "lua/plugins/debugging.lua" "php-debug-adapter"
assert_contains "lua/plugins/debugging.lua" "debugpy"
assert_contains "lua/plugins/debugging.lua" "delve"
